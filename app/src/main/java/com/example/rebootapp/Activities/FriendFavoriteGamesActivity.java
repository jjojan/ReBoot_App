...
public class FriendFavoriteGamesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        favoriteGamesAdapter = new FavoriteGamesAdapter(gamePhotoUris, friend_ID);
...
//        fillPhotos();
    ...
    public void fillPhotos(){
        ...
        gamesQuery.whereEqualTo("user_id", friend_ID);
